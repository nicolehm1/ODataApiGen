...
{
    public class Module : FlutterRenderable
    {
        ...
        // Imports and Exports
        public override IEnumerable<string> ImportTypes => Package.Schemas.SelectMany(s => s.Containers.SelectMany(c => c.Services)).Select(a => a.EntityType);
