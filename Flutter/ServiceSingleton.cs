...
namespace ODataApiGen.Flutter
{
    public class ServiceSingleton : Service
  {
    ...
    public override string Name => Utils.ToDartName(EdmSingleton.Name, DartElement.Class) + "Service";
    ...
    public override string EntitySetName => EdmSingleton.Name;
    ...
    public string ServiceType => EdmSingleton.NamespaceQualifiedName;
